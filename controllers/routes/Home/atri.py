...
class Atri:
	def __init__(self, state: Any):
		...
		self.restaurant = state["restaurant"]
	...
	@property
	def restaurant(self):
		self._getter_access_tracker["restaurant"] = {}
		return self._restaurant
	@restaurant.setter
	def restaurant(self, new_state):
		self._setter_access_tracker["restaurant"] = {}
		global default_state
		self._restaurant = Image(new_state, default_state["restaurant"])
